...
#Pytorch dataset builder for testing and training
class datasetBuilder(Dataset):
    def __init__(self, root_path, test=False):
        ...
        self.transform = transforms.Compose([
            ...
            transforms.ToTensor()])
    # If your image has 3 channels and mask has 1 channel
...
#  #Debugging
# root_path = "C:\\Users\\Utsav\\OneDrive\\Desktop\\research\\diy\\test_Dataset"
# dataset = datasetBuilder(root_path)
